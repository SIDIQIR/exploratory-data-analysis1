...
plot(subt$Global_active_power ~ subt$DateandTime, type="l",col = "dark blue", ylab = "Global Active Power", xlab = "By Date and Time")
plot(subt$Voltage ~ subt$DateandTime, type="l", ylab = "Voltage",col = "dark blue", xlab = "By Date and Time")
with(subt, {plot(Sub_metering_1 ~ DateandTime, type="l", xlab= "By Date and Time", ylab="Energy Sub Metering")})
...
plot(subt$Global_reactive_power ~ subt$DateandTime, type="l",col = "blue", ylab = "Global Reactive Power", xlab = "By Date and Time" )
